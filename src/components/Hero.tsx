  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-beige-50 via-beige-100/50 to-beige-200/30">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/3 left-1/4 w-3 h-3 bg-beige-500/50 rounded-full animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-2/3 right-1/3 w-5 h-5 bg-beige-400/40 rounded-full animate-float-reverse"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="absolute bottom-20 left-2/3 w-2 h-2 bg-beige-500/70 rounded-full animate-drift"
          style={{ animationDelay: "6s" }}
        ></div>

        {/* Geometric shapes */}
        <div
          className="absolute top-1/4 left-1/3 w-8 h-8 bg-gradient-to-br from-beige-300/40 to-beige-400/40 rotate-45 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-6 h-6 bg-gradient-to-br from-beige-400/50 to-beige-300/50 rotate-12 animate-float-reverse"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-gray-800 mb-6 tracking-tight">
                Hi, I'm{" "}
                <span
                  className="font-medium text-olive-300 animate-fade-in-name"
                  style={{
                    animationDelay: "0.4s",
              ...
              <p className="text-xl sm:text-2xl text-gray-600 mb-8 font-light">
                Senior SWE @ {experiences[0].company}
              </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-6 mb-12 text-sm text-gray-600">
                ...
                <a
                  href="https://linkedin.com/in/aviralpulast"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-olive-400 transition-colors"
                  aria-label="LinkedIn"
                >
                  <Linkedin size={16} className="text-olive-300" />
                  <span className="hidden sm:inline">aviralpulast</span>
                </a>
              </div>
